...
class F1_season():
    ...
    def load_season_data(self):
        ...
        #Headless version for the Docker image
        options = Options()
        ...
        #Non-headless version for the pypi package
        #driver = webdriver.Chrome()
        
        current_year = self.year
        URL = 'https://www.formula1.com/en/results.html/' + str(current_year) + '/races.html'
        
        #Non-headless line of code used for the pypi package
    ...
    #from here onwards is when problems start with docker
    def load_race(self,race_number,web):
        ...
        #docker version
        element = web.find_element_by_xpath('/html/body/div[2]/main/article/div/div[2]/div[1]/div[3]/ul/li[' + str(race_number + 1) + ']')
        web.execute_script("arguments[0].click();", element)
        
        time.sleep(6)
    
    #says the element doesnt exist
